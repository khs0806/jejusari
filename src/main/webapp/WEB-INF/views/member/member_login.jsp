...
<link rel="stylesheet" href="${root}/css/member/member_login.css">
	<div class="login">
		...
		<div class="kakao">
			<!-- 카카오로 로그인 링크 ----------------------------------------------------------------->
			<a href="https://kauth.kakao.com/oauth/authorize?client_id=47d269828391ebdbbd9ef43e5d60962c&redirect_uri=http://localhost:8080/jejusari/test/join&response_type=code"> <!----------------------------->
