...
public class MemberDto {
	...
	public MemberDto(String member_id, String member_pwd, int member_number, String member_name, String member_email,
			String member_phone, String member_level, String member_register_date) {
		super();
	...
	public String toString() {
		return "MemberDto [member_id=" + member_id + ", member_pwd=" + member_pwd + ", member_number=" + member_number
				...
				+ ", member_level=" + member_level + ", member_register_date=" + member_register_date + "]";
	}
